            ...
            if 'level' in session:
                ...
                #lower numbers give more power
                    ...
                    if session['level'] == 2:
                        ...
                        body = """<p>The account is not available to be used for advanced operations until a staff member from Rudraya activates it</p>"""
                        return render_template('completepage.html', header = header, body = body, user = session['user'])
                        ...
                        return render_template('completepage.html', header = header, body = body % (url_for('users.resendactivationemail')), user = session['user'])
                ...
                loginForm.wantsurl.data = request.path
